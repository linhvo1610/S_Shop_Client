...
public class HuyBill extends AppCompatActivity {
    ...
    String idpro;
    private void hienthiHuyDon() {
        RequestQueue requestQueue = Volley.newRequestQueue(getBaseContext());
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, API.api + "billCancel?id_user=" + iduser + "&status=Hủy đơn", null, new Response.Listener<JSONObject>() {
            @Override
